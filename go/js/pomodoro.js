...
function toggleVisible(showHide) {
    ...
    if (showHide === "show") {
        ...
        top.animate({
            ...
            $("#message").text("👌 Que sea una productiva sesión de trabajo, Go! ");
            $("#message").fadeIn(300);
        });
        bottom.slideUp(300);
    }
...
$(document).ready(function() {
    ...
    $("#action1").click(function() {
        if (pomodoro.action1 === "start" ||
            ...
            pomodoro.action1 = "⏸️ Parar";
            $(this).text(pomodoro.action1);
            $("#action2").css({
                "visibility": "visible"
            });
        } else if (pomodoro.action1 === "⏸️ Parar") {
            pomodoro.pause();
            pomodoro.action1 = "Resumen";
            $(this).text(pomodoro.action1);
        }
