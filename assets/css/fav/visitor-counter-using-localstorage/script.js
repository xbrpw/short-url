...
if (typeof Storage !== "undefined") {
  ...
  if (!localStorage.visited) {
    ...
    document.getElementById("visitorcounter").innerHTML = 'Welcome, You visited this page '+ localStorage.siteVisitCount + 'time';
    // need to send updated value to database 
    localStorage.visited = true;
  }else{
    document.getElementById("visitorcounter").innerHTML = 'You have visited here more then once within 24 hours';
  }
