...
(function (WeatherType) {
    WeatherType["Cloudy"] = "Activo";
    WeatherType["Rainy"] = "Pasivo";
    WeatherType["Stormy"] = "Inter";
    WeatherType["Sunny"] = "Wuaguero";
...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Proxima cogedera slameados full ",
...
const Pin = () => {
    ...
    const getErrorText = () => {
        if (userStatus === UserStatus.LogInError) {
            return (React.createElement("span", { id: "app-pin-error-text" }, "Invalido"));
        }
    };
    return (React.createElement("div", { id: "app-pin-wrapper" },
        ...
        React.createElement("div", { id: "app-pin", onClick: handleOnClick },
            ...
            React.createElement(PinDigit, { focused: pin.length === 1, value: pin[0] }),
            React.createElement(PinDigit, { focused: pin.length === 2, value: pin[0] }),
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Sobre el lugar..." }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Las mas cerraditas o boquetonas",
                id: 1,
                image: "./pas.jpg",
                title: "Pasivos"
            }, {
                desc: "Unos dragonazos",
                id: 2,
                image: "./fumar.webp",
                title: "Fumar"
            }, {
                desc: "Activos vergones super vergones",
                id: 3,
                image: "./activo.webp",
                title: "Activos"
            }, {
                desc: "Un buen arponazo",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "De qué tienes ganas" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "index.html", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "Manual del nalgeo")),
