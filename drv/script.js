$(document).ready(function () {
  ...
  // Generating slides
  let arrCities = ['Iris XC', 'LeenoxGyarada', 'Mikonika Q Love', 'Becky____D´Vich', 'NiihaVillant', 'LeeMong']; // Change number of slides in CSS also
  ...
  let generateSlide = function (city) {
    ...
    if (arrCities[city].length <= 4) {
      $('.slide--' + numSlide).find('.slide__text').css("font-size", "9vw");
    }
  };
