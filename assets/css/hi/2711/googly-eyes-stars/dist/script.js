...
(function (Demo) {
    ...
    class Block extends PIXI.Container {
        constructor(x, y) {
            ...
            this.originX = 63;
            this.originY = 36;
            this.leftEye = new Eye(18, 29);
            this.rightEye = new Eye(66, 29);
            this.face = new PIXI.Sprite(blockTextures[blockColor]);
    ...
    class Star extends PIXI.Sprite {
        constructor(emitter) {
            ...
            this.isActive = false;
            this.delay = _.random(delayMin, delayMax);
            this.time = _.random(timeMin, timeMax);
            this.totalTime = this.delay + this.time;
            this.alpha = 0;
            this.visible = false;
    ...
    class StarEmitter {
        constructor() {
            this.cachedStars = new LinkedList();
            this.container = new PIXI.ParticleContainer(starCount, {
                position: true,
                rotation: false,
                alpha: true,
                scale: true,
