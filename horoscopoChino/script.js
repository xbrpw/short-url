function birthDate() {
    ...
    var animals = ["mono", "gallo", "perro", "cerdo", "rata", "buey", "tigre", "conejo", "dragón", "serpiente", "caballo", "cabra"];
    var stars = [" Aries", " Tauro", " Geminis", "Cancer", " Leo", "Virgo", "Libra", "Escorpión", "Sagitario", "Capricornio", "Acuario", "Piscis"];
    ...
    if (year === "" || month === "" || day === "") {
        ...
        document.getElementById("display").innerHTML = "Tu eres " + star + " nacido en el año del " + animal;
