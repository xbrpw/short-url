...
function errorHandling() {
  ...
  var b = document.getElementById("howInput").value;
...
var submitInformation = function() {	
  ...
  var howInput = document.getElementById("howInput").value;
  ...
  var cleaning = function() {
    ...
    document.getElementById("howInput").value = '';
    }	  
  cleaning();							
...
var tableBuildFunc = function() {  
  ...
  for (var i in coolPeople) {
    html += '<tr><td>' + coolPeople[i].Name +'</td><td>' + coolPeople[i].Age + '<td><td>' + coolPeople[i].Text + '<td>' + '<button data-index="' + i +'" onclick="deleteButtonClick(event)" type="submit">x</button>' + '</td></td></tr>';
  }
